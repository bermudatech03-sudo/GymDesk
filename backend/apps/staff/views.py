...
def _record_expense(staff, amount, month):
    """Auto-create Expenditure when salary is marked paid."""
    ...
    Expenditure.objects.create(
        ...
        vendor=staff.name,
        notes=f"Role: {staff.role} | Shift: {staff.shift}",
    )
...
class StaffViewSet(viewsets.ModelViewSet):
    ...
    def generate_payments(self, request):
        """Generate pending salary records for all active staff for given month."""
        import datetime
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def mark_paid(self, request, pk=None):
        ...
        p.save()
        # Auto-create Expenditure in finances
